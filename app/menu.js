...
export default class MenuBuilder {
  ...
  buildDarwinTemplate() {
    const subMenuAbout = {
      label: 'Pinaple',
      submenu: [
        { label: 'About Pinaple', selector: 'orderFrontStandardAboutPanel:' },
        { type: 'separator' },
        { label: 'Services', submenu: [] },
        { type: 'separator' },
        { label: 'Hide Pinaple', accelerator: 'Command+H', selector: 'hide:' },
        { label: 'Hide Others', accelerator: 'Command+Shift+H', selector: 'hideOtherApplications:' },
        { label: 'Show All', selector: 'unhideAllApplications:' },
        { type: 'separator' },
        { label: 'Quit Pinaple', accelerator: 'Command+Q', click: () => { app.quit() } },
      ],
    }
    const subMenuEdit = {
      label: 'Edit',
